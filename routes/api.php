...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::apiResource('/companies', CompanyController::class)->only(['index', 'show', 'store']);
});

// Super Admin only - no company context needed
Route::middleware(['auth:sanctum', 'role:super_admin'])->group(function () {
    Route::apiResource('/users', UserController::class);
});

// --- Everything below is scoped to selected company ---
...
Route::middleware(['auth:sanctum', 'role:super_admin,admin', 'company'])->group(function () {
    ...
    Route::post('/clients/{client}/assign', [ClientsProjectController::class, 'assignProject']);
